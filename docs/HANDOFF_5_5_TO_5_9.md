...
| 項目 | 値 | source |
|------|----|--------|
| **5/5 朝 累計** | **+13,530円** (生データ、 5/5 朝 snapshot) / **+14,140円** (USER 申告) ※ 当時 record。 5/16 P0-1 真値 (n=563、 ≤5/16): **+¥5,240** / ROI 101.33% (docs/ROI_DISCREPANCY_2026_05_16.md) | 5/6 Session #27 真相確定 (`data/v18/may_2_3_truth_audit_5_6.md`)。±610 円差は要 USER 確認 |
| **5/2 USER 実投資** | **-9,350円** (15R 1hit) | cumulative_results 集計、引き継ぎ書 v2 -8,820 と ±530 円差 |
| **5/3 USER 実投資** | **-7,950円** (22R 4hits) | 同上 |
| **5/5 NAR 柏記念** | **+310円** | 三連複 7点 #3-#8-#10、配当 1,010 円 |
| 撤退ライン (絶対) | -50,000円 | 全 session 一貫 |
| **撤退まで余裕** | **+63,530円** (生データ) / +64,140円 (USER 申告) | 50,000 + 累計 |
| 5/9 最悪 | -2,100円 → 累計 +11,430円 (生データ) | 案B改 上限 |
| 5/9-5/10 最悪 | -4,200円 → 累計 +9,330円 (生データ) | 両日上限 |
