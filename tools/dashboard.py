...
USER_CUMULATIVE: list[tuple[str, int, str]] = [
    ...
    # 5/6 Session #27 真相確定 (data/v18/may_2_3_truth_audit_5_6.md):
    # 生データ cumulative_results.csv 集計 + NAR 柏記念
    # USER 申告 +14,140 円 と生データ +13,530 円 で ±610 円差、本書は生データ採用
    ("2026-05-01", 30_520, "GW前 累計起点 (5/2 直前、逆算)"),
    ("2026-05-02", 21_170, "5/2 USER 実投資 -9,350 (15R 1 hit)"),
    ("2026-05-03", 13_220, "5/3 USER 実投資 -7,950 (22R 4 hits)"),
    ("2026-05-05", 13_530, "5/5 NAR 柏記念 +310 (累計 +13,530)"),
    ("2026-05-09", 13_530, "5/9 投資前 (現在、撤退余裕 +63,530)"),
]
